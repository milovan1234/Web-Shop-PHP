...
$(document).ready(function() {
    let urladresa = "telefonija.php?broj-strane=1";

$(".btn-page").click(function() {
    let button = $(this);
    let urladresa ="telefonija.php?broj-strane=" + button.attr("btn-id");
    if ($("#sort-cena").val() != "") {
...
$(".btn-page-prev").click(function() {
    ...
    if (index > 0) {
        urladresa ="telefonija.php?broj-strane=" + (numOfPage - 1);
        if ($("#sort-cena").val() != "") {
            urladresa += "&sort-cena=" + $("#sort-cena").val();
        }
        if ($("#sort-vreme").val() != "") {
...
$("#sort-cena").change(function() {
    ...
    urladresa = "telefonija.php?broj-strane=1";
    if ($(sortArtikla).val() != "") {
