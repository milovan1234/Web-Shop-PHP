...
<body>
    ...
    <div class="container">
        ...
        <?php
            ...
            $query = "SELECT * FROM Artikal WHERE Aktivan=1 AND IdGrupe IN(SELECT Id FROM Grupa WHERE Naziv='TV')"; //Upit koji uzima sve artikle za trazenu grupu
            ...
            echo '
                <h2 class="text-dark text-center font-weight-normal my-4">TV</h2>
    ...
    <?php 
        ...
        ';
        echo '
            <script src="js/js-televizija.js"></script>
        '; 
    ?>
